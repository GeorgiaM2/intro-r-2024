...
# changing time zone from numeric to character ----
...
#### I want the total daily valume and avg volume and avg speed/station ####
data_stid <- data |> 
